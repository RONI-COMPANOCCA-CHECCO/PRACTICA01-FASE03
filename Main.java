public class Main {
    public static void main(String[] args) {
        ...
        Branch branch1 = new Branch("BRANCH-001", "Sucursal A", "Dirección A");
        Branch branch2 = new Branch("BRANCH-002", "Sucursal B", "Dirección B");
        Branch branch3 = new Branch("BRANCH-003", "Sucursal C", "Dirección C");
        Branch branch4 = new Branch("BRANCH-004", "Sucursal D", "Dirección D");
